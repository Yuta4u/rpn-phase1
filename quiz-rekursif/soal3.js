...
function consonantCounterRecursive(sentences) {
  //code here
  //   let abc = "aiueo"
  console.log(new Set(sentences))
  //   let test = abc.split("").filter((e) => e == sentences[0]).length !== 0 && true
  //   if (sentences.length === 0) {
  //     return 0
  //   } else {
  //     return (test ? 1 : 0) + consonantCounterRecursive(sentences.substr(1))
  //   }
}

console.log(consonantCounterRecursive("alDi Suka MakAn baksO")) //10
console.log(consonantCounterRecursive("lD Sk MkAn bksO")) //10
console.log(consonantCounterRecursive("dziZy")) // 3
